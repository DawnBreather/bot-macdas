...
class Configuration:
    ...
    bybit_position_settings_sell_leverage = '3'
    ...
    def __init__(self, ssm_enabled=True):
        ...
        self.__init_parameters(self, ssm_connector)
    ...
    def __get_parameter(self, parameter_name, ssm_connector):
        ...
        # SSM
        if ssm_connector:
            tmp = self.__get_parameter_from_ssm(parameter_name, ssm_connector)
            if tmp:
                value = tmp
